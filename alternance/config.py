...
# Racine du DEPOT, pas du paquet : data/, lettres/, templates/ et
# prompts/ vivent a cote de alternance/, pas dedans. Definie une seule
# fois ici, les autres modules l'empruntent plutot que de recalculer un
# nombre de `.parent` qui depend de leur profondeur.
...
#   - redaction/lettres.py annonce la bonne nature au redacteur
...
from alternance import parametres as _parametres  # noqa: E402
