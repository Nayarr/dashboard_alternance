...
def main():
    """Le corps tournait au niveau du module : un simple import
    ouvrait la base et affichait tout. Inutilisable depuis un
    point d'entree commun, et surprenant partout ailleurs."""
    conn = db.connect()
