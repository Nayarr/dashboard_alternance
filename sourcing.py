"""Orchestrateur de collecte : interroge les sources, score, filtre, stocke.
    ...
    python sourcing.py              # toutes les sources disponibles
    python sourcing.py --source lba
    python sourcing.py --no-spontanees
"""
...
import config  # noqa: F401  (charge le .env)
import db
import filters
from sources import apec, france_travail, jobteaser, lba, service_public, wttj
