...
Sans --confirmer, le script remplit tout, prend une capture et n'envoie pas.
    ...
    python postuler_lba.py --limite 3                # repetition a blanc
    python postuler_lba.py --limite 3 --confirmer    # envoi reel
    python postuler_lba.py --limite 20 --confirmer --headless
"""
...
def main():
    ...
    if not offres:
        raise SystemExit("aucune offre avec lettre prete. Lancer generer_lettres.py")
