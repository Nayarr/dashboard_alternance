...
interactive : c'est le mecanisme officiel prevu pour un abonnement.
    ...
    python generer_lettres.py --limite 5          # les 5 meilleurs scores
    python generer_lettres.py --offre 59          # une offre precise
    python generer_lettres.py --limite 50 --force # regenere meme si deja ecrite
"""
